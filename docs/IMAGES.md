...
### 2. ตั้งชื่อไฟล์ตามเลขใบแรกในภาพ
...
**ตัวที่ยังไม่มี slug จะถูกข้าม** พร้อมบอกว่าข้ามตัวไหน ตอนนี้มี 6 ตัวที่ชื่ออังกฤษยังโดนตัด
(field 34, 36, 151 และ event 1–3)
...
`assets-src/` อยู่ใน `.gitignore` — ภาพแคปดิบไม่ถูก commit มีแต่ไฟล์ `.webp` ที่ตัดแล้วเท่านั้น
