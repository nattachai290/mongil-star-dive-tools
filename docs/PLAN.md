...
**สัญญาณที่ต้องระวัง — เลข 6.25% ซ้ำข้ามสายพันธุ์:** มอนเลเวล 1 สี่ตัว
(แกบีฟ้า, แอกโซลอเติลหอยสังข์, หมาป่า, ออร์ค นักรบ) ขึ้น **6.25% เท่ากันเป๊ะ**
ทั้งที่คนละสายพันธุ์และคนละเอฟเฟกต์

ถ้าตัวเลขเป็นของสายพันธุ์จริง ไม่มีทางตรงกันสี่ตัวรวด แปลว่าเลขนี้มาจากแรง
และ **6.25 ≠ 6.57 ของก็อบลิน ร้อยตรีที่ยืนยันแล้วว่าสีทอง** → สี่ตัวนี้น่าจะยังไม่ใช่สีทอง

จึงเก็บไว้เฉพาะ **รูปแบบ** ของเอฟเฟกต์ (ไม่ขึ้นกับแรง) ยังไม่เก็บตัวเลข
`validate:data` ฟ้องไว้ทั้งสี่ไฟล์
